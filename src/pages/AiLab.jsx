...
const labItems = [
  ...
  ['Workflow AI', 'Tự động hóa các bước lặp lại trong xử lý visual và hồ sơ.'],
  ['GPT cho nội thất', 'Gợi ý concept, nhịp không gian và ngôn ngữ vật liệu.'],
  ['Automation tools', 'Các công cụ nhỏ để việc dựng và trình bày diễn ra nhanh hơn.'],
];
    ...
    <div className="page-wrap ai-page-v3">
      <section className="section-shell ai-hero-v3">
        <Reveal className="ai-hero-copy">
          ...
          <p>
            VTARCH dùng AI để mở rộng tốc độ nghiên cứu, thử concept và tự động hóa workflow, nhưng trọng tâm vẫn
        ...
        <Reveal className="ai-hero-visual" delay={120} variant="scale">
          ...
          <div>
            <span>AI CGI / Workflow / Prompt</span>
            <strong>Studio tooling for visual design.</strong>
          </div>
        </Reveal>
      </section>
