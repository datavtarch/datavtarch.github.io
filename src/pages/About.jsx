...
import { ArrowUpRight, Calendar, Mail, MapPin, Phone, Sparkles } from 'lucide-react';
      ...
      <section className="section-shell space-y-12 md:space-y-16">
        <div className="relative neo-card rounded-[2rem] p-6 md:p-10 overflow-hidden">
          ...
          <div className="relative z-10 grid lg:grid-cols-[.9fr_1.1fr] gap-9 md:gap-12 items-center">
            ...
            <div>
              <div className="eyebrow mb-6">Architecture · CGI · AI</div>
              <h1 className="text-5xl md:text-7xl font-black font-heading uppercase tracking-[-0.07em] leading-[0.9] mb-7">
                Visual <br /> <span className="gradient-title">Designer</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link to="/portfolio" className="btn-outline-luxury px-8 py-4 text-xs font-mono uppercase tracking-widest inline-flex items-center justify-center">
                  Xem dự án
                </Link>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-[.8fr_1.2fr] gap-6">
          ...
          <div className="neo-card rounded-[2rem] p-7 md:p-8">
            <div className="flex items-center gap-3 mb-7">
              ...
              <h3 className="text-2xl font-black font-heading uppercase">Skills Matrix</h3>
            </div>
